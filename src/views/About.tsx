      ...
      >
        <div className="flex-1 flex flex-col gap-4">
          ...
          <Reveal>
            ...
            My name is Ahmed. I am a website and application programmer.
            I built this application to increase the effectiveness of the boycott to
            a greater degree of villains’ products.
            I hope you like the application, and if you have a suggestion for development
             or modifications or encounter any problems, contact me
            </p>
          </Reveal>
