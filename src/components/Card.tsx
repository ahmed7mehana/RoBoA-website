...
const Card: FC<CardProps> = ({ imgSrc, title ,V}) => {
  return (
    <div
    ...
    >
      <p  className="text-textPrimary absolute bottom-0 left-1/2 -translate-x-1/2 opacity-0 group-hover:bottom-6 group-hover:opacity-100
